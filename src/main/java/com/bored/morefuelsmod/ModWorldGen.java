...
//No way to add to init
//Borrowed code from a friend, need his assistance making it work with the mod, but it is set up to spawn the Bituminous Coal ore
//once a method to add it to init is found
